...
const Hero = () => {
    return (
        <div name = 'hero' className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
            ...
            <div className='absolute flex flex-col py-8 md:min-w-[760px] bottom-[5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinx-200 border-slate-300 rounded-xl text-center shadow-xl'>
                <p>Data Services</p>
